/** Shared style constants for the Friends window - matches the existing
 * dark editor palette (see hair-prototype/CharacterPanel.tsx) rather than
 * inventing a new visual language, and keeps this normal-framed window
 * visually distinct from the Desktop Avatar's transparent/glassy HUD
 * style (section 24 - never apply the Desktop window's transparent look
 * here). */
